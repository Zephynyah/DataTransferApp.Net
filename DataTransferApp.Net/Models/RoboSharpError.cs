...
namespace DataTransferApp.Net.Models
{
    ...
    public class RoboSharpError
    {
        ...
        /// <summary>
        /// The error code or exit code from Robocopy.
        /// </summary>
        ...
        /// <summary>
        /// The directory path associated with the error, if applicable.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether this error is recoverable with retry.
        /// </summary>
        public bool IsRecoverable { get; set; }

        /// <summary>
        /// Indicates whether this error caused the operation to fail completely.
        /// </summary>
        ...
        public static RoboSharpError FromExitCode(int exitCode, string sourcePath = "", string destPath = "")
        {
            ...
            else if ((exitCode & 8) != 0) // Copy errors
            {
            ...
            else if ((exitCode & 4) != 0) // Mismatches
            {
            ...
            else if ((exitCode & 2) != 0) // Extra files
            {
            ...
            else if (exitCode == 1 || exitCode == 0) // Success cases
            {
